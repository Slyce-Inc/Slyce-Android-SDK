...
public class SlyceSDK_Snippets {
    ...
    void reportManualAnalytics(Context context) throws SlyceNotOpenedException {
        ...
        // track add to cart
        Slyce.getInstance(context).getEventTracker().trackAddToCartTap(itemId, itemRevenue, itemURL, itemQuantity);

        // track successful checkout
        Slyce.getInstance(context).getEventTracker().trackCheckoutTap(itemId, itemRevenue, itemURL,itemQuantity);
    }
}