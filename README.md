...
* These docs in the SDK, which include an overview of usage (PDF), [API Reference (Java docs)](http://github.com/Slyce-Inc/Slyce-Android-SDK/Slyce-javadoc/index.html), and sample code.
