...
public class ByteBufferList {
    com.android.slyce.async.ArrayDeque<ByteBuffer> mBuffers = new com.android.slyce.async.ArrayDeque<ByteBuffer>();
...
//            System.out.println("reclaiming remaining: " + b.remaining());
    ...
    public String peekString(Charset charset) {
        if (charset == null)
            charset = com.android.slyce.async.util.Charsets.US_ASCII;
