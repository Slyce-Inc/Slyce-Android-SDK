...
public class PushParser implements com.android.slyce.async.callback.DataCallback {
    ...
    public PushParser until(byte b, com.android.slyce.async.callback.DataCallback callback) {
    ...
    public void tap(com.android.slyce.async.TapCallback callback) {
        mWaiting.add(new TapWaiter(callback));
    }

    static Hashtable<Class, Method> mTable = new Hashtable<Class, Method>();
    static Method getTap(com.android.slyce.async.TapCallback callback) {
