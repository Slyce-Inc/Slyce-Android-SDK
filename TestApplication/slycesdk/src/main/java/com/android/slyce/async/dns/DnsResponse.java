...
public class DnsResponse {
    ...
    public com.android.slyce.async.http.Multimap txt = new com.android.slyce.async.http.Multimap();
    public InetSocketAddress source;

    private static String parseName(com.android.slyce.async.ByteBufferList bb, ByteBuffer backReference) {
        ...
        while (0 != (len = bb.get() & 0x00FF)) {
            ...
            if ((len & 0x00c0) == 0x00c0) {
                ...
                if (ret.length() > 0)
                    ret += ".";
                com.android.slyce.async.ByteBufferList sub = new com.android.slyce.async.ByteBufferList();
    ...
    public static DnsResponse parse(com.android.slyce.async.ByteBufferList bb) {
        ...
        for (int i = 0; i < answers; i++) {
            ...
            try {
                if (type == 1) {
                    ...
                    com.android.slyce.async.ByteBufferList txt = new com.android.slyce.async.ByteBufferList();
                    bb.get(txt, length);
...
//                e.printStackTrace();
    ...
    void parseTxt(com.android.slyce.async.ByteBufferList bb) {
