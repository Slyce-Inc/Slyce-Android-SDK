...
import com.android.slyce.async.ArrayDeque;
...
import com.android.slyce.async.callback.ContinuationCallback;
...
import com.android.slyce.async.future.SimpleCancellable;
import com.android.slyce.async.future.TransformFuture;
...
public class AsyncSocketMiddleware extends SimpleMiddleware {
    ...
    protected com.android.slyce.async.callback.ConnectCallback wrapCallback(GetSocketData data, Uri uri, int port, boolean proxied, com.android.slyce.async.callback.ConnectCallback callback) {
        return callback;
    }
    ...
    class IdleSocketHolder {
        public IdleSocketHolder(com.android.slyce.async.AsyncSocket socket) {
            this.socket = socket;
        }
        com.android.slyce.async.AsyncSocket socket;
        long idleTime = System.currentTimeMillis();
    }

    static class ConnectionInfo {
        int openCount;
        com.android.slyce.async.ArrayDeque<GetSocketData> queue = new com.android.slyce.async.ArrayDeque<GetSocketData>();
        com.android.slyce.async.ArrayDeque<IdleSocketHolder> sockets = new com.android.slyce.async.ArrayDeque<IdleSocketHolder>();
    }
    ...
    public com.android.slyce.async.future.Cancellable getSocket(final GetSocketData data) {
        ...
        synchronized (AsyncSocketMiddleware.this) {
            if (info.openCount >= maxConnectionCount) {
                ...
                com.android.slyce.async.future.SimpleCancellable queueCancel = new com.android.slyce.async.future.SimpleCancellable();
                info.queue.add(data);
                return queueCancel;
            }
            ...
            while (!info.sockets.isEmpty()) {
                ...
                final com.android.slyce.async.AsyncSocket socket = idleSocketHolder.socket;
        ...
        .then(new TransformFuture<AsyncSocket, InetAddress[]>() {
            ...
            protected void transform(final InetAddress[] result) throws Exception {
                com.android.slyce.async.future.Continuation keepTrying = new Continuation(new CompletedCallback() {
                    @Override
