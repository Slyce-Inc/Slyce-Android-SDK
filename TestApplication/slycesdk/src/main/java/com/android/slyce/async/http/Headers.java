...
public class Headers {
    ...
    final com.android.slyce.async.http.Multimap map = new com.android.slyce.async.http.Multimap() {
        @Override
        protected List<String> newList() {
            return new com.android.slyce.async.util.TaggedList<String>();
        }
    };
    public com.android.slyce.async.http.Multimap getMultiMap() {
        return map;
    }
    ...
    public Headers set(String header, String value) {
        ...
        map.put(lc, value);
        com.android.slyce.async.util.TaggedList<String> list = (com.android.slyce.async.util.TaggedList<String>)map.get(lc);
        list.tagNull(header);
        return this;
    }
    ...
    public Header[] toHeaderArray() {
        ...
        for (String key: map.keySet()) {
            com.android.slyce.async.util.TaggedList<String> list = (com.android.slyce.async.util.TaggedList<String>)map.get(key);
