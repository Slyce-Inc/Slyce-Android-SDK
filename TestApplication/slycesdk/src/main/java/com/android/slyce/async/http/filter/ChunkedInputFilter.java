...
public class ChunkedInputFilter extends com.android.slyce.async.FilteredDataEmitter {
    ...
    @Override
    public void onDataAvailable(DataEmitter emitter, com.android.slyce.async.ByteBufferList bb) {
        try {
                ...
                case CHUNK_LEN:
                    ...
                    if (c == '\r') {
                        ...
                        if (c >= 'a' && c <= 'f')
                            ...
                            report(new com.android.slyce.async.http.filter.ChunkedDataException("invalid chunk length: " + c));
                            return;
                        }
                    }
