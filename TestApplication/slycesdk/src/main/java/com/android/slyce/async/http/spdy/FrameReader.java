...
//  boolean nextFrame(Handler handler) throws IOException;
    ...
    public interface Handler {
        ...
        void data(boolean inFinished, int streamId, com.android.slyce.async.ByteBufferList bb);
        ...
        void headers(boolean outFinished, boolean inFinished, int streamId, int associatedStreamId,
                     List<com.android.slyce.async.http.spdy.Header> headerBlock, com.android.slyce.async.http.spdy.HeadersMode headersMode);

        void rstStream(int streamId, com.android.slyce.async.http.spdy.ErrorCode errorCode);
         ...
         */
        void goAway(int lastGoodStreamId, com.android.slyce.async.http.spdy.ErrorCode errorCode, ByteString debugData);
