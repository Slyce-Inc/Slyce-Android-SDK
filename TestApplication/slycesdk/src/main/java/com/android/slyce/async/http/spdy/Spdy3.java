...
final class Spdy3 implements Variant {
    ...
    @Override
    public com.android.slyce.async.http.Protocol getProtocol() {
        return com.android.slyce.async.http.Protocol.SPDY_3;
    }
    ...
    static {
        try {
            ...
            + "sdchcharset=utf-8charset=iso-8859-1,utf-,*,enq=0.").getBytes(com.android.slyce.async.util.Charsets.UTF_8.name());
    ...
    @Override
    public FrameReader newReader(com.android.slyce.async.DataEmitter source, FrameReader.Handler handler, boolean client) {
        return new Reader(source, handler, client);
    }

    @Override
    public FrameWriter newWriter(com.android.slyce.async.BufferedDataSink sink, boolean client) {
    ...
    static final class Reader implements FrameReader {
        private final com.android.slyce.async.http.spdy.HeaderReader headerReader = new com.android.slyce.async.http.spdy.HeaderReader();
        private final com.android.slyce.async.DataEmitter emitter;
        private final boolean client;
        private final Handler handler;
        private final com.android.slyce.async.DataEmitterReader reader;

        Reader(com.android.slyce.async.DataEmitter emitter, Handler handler, boolean client) {
            ...
            reader = new com.android.slyce.async.DataEmitterReader();
            parseFrameHeader();
        }
        ...
        int streamId;
        boolean inFinished;
        private final com.android.slyce.async.ByteBufferList emptyList = new com.android.slyce.async.ByteBufferList();
        private final com.android.slyce.async.callback.DataCallback onFrame = new com.android.slyce.async.callback.DataCallback() {
            @Override
        ...
        com.android.slyce.async.ByteBufferList partial = new com.android.slyce.async.ByteBufferList();
        private final com.android.slyce.async.callback.DataCallback onDataFrame = new com.android.slyce.async.callback.DataCallback() {
            @Override
            public void onDataAvailable(com.android.slyce.async.DataEmitter emitter, com.android.slyce.async.ByteBufferList bb) {
        ...
        private final com.android.slyce.async.callback.DataCallback onFullFrame = new com.android.slyce.async.callback.DataCallback() {
            @Override
            public void onDataAvailable(com.android.slyce.async.DataEmitter emitter, com.android.slyce.async.ByteBufferList bb) {
        ...
        */
        ...
        private void readSynStream(com.android.slyce.async.ByteBufferList source, int flags, int length) throws IOException {
            int w1 = source.getInt();
            int w2 = source.getInt();
            int streamId = w1 & 0x7fffffff;
            int associatedStreamId = w2 & 0x7fffffff;
            source.getShort(); // int priority = (s3 & 0xe000) >>> 13; int slot = s3 & 0xff;
            List<com.android.slyce.async.http.spdy.Header> headerBlock = headerReader.readHeader(source, length - 10);
            ...
            com.android.slyce.async.http.spdy.HeadersMode.SPDY_SYN_STREAM);
        }

        private void readSynReply(com.android.slyce.async.ByteBufferList source, int flags, int length) throws IOException {
            int w1 = source.getInt();
            int streamId = w1 & 0x7fffffff;
            List<com.android.slyce.async.http.spdy.Header> headerBlock = headerReader.readHeader(source, length - 4);
            boolean inFinished = (flags & FLAG_FIN) != 0;
            handler.headers(false, inFinished, streamId, -1, headerBlock, com.android.slyce.async.http.spdy.HeadersMode.SPDY_REPLY);
        }

        private void readRstStream(com.android.slyce.async.ByteBufferList source, int flags, int length) throws IOException {
            ...
            com.android.slyce.async.http.spdy.ErrorCode errorCode = com.android.slyce.async.http.spdy.ErrorCode.fromSpdy3Rst(errorCodeInt);
            if (errorCode == null) {
        ...
        private void readHeaders(com.android.slyce.async.ByteBufferList source, int flags, int length) throws IOException {
            int w1 = source.getInt();
            int streamId = w1 & 0x7fffffff;
            List<com.android.slyce.async.http.spdy.Header> headerBlock = headerReader.readHeader(source, length - 4);
            handler.headers(false, false, streamId, -1, headerBlock, com.android.slyce.async.http.spdy.HeadersMode.SPDY_HEADERS);
        }

        private void readWindowUpdate(com.android.slyce.async.ByteBufferList source, int flags, int length) throws IOException {
        ...
        private void readPing(com.android.slyce.async.ByteBufferList source, int flags, int length) throws IOException {
        ...
        private void readGoAway(com.android.slyce.async.ByteBufferList source, int flags, int length) throws IOException {
            if (length != 8) throw ioException("TYPE_GOAWAY length: %d != 8", length);
            int lastGoodStreamId = source.getInt() & 0x7fffffff;
            int errorCodeInt = source.getInt();
            com.android.slyce.async.http.spdy.ErrorCode errorCode = com.android.slyce.async.http.spdy.ErrorCode.fromSpdyGoAway(errorCodeInt);
            if (errorCode == null) {
        ...
        private void readSettings(com.android.slyce.async.ByteBufferList source, int flags, int length) throws IOException {
    ...
    static final class Writer implements FrameWriter {
        private final com.android.slyce.async.BufferedDataSink sink;
        private final boolean client;
        private boolean closed;
        private com.android.slyce.async.ByteBufferList frameHeader = new com.android.slyce.async.ByteBufferList();
        private final Deflater deflater = new Deflater();

        Writer(com.android.slyce.async.BufferedDataSink sink, boolean client) {
            this.sink = sink;
            this.client = client;
        ...
        public synchronized void synStream(boolean outFinished, boolean inFinished,
                                           int streamId, int associatedStreamId, List<com.android.slyce.async.http.spdy.Header> headerBlock)
        throws IOException {
            if (closed) throw new IOException("closed");
            com.android.slyce.async.ByteBufferList headerBlockBuffer = writeNameValueBlockToBuffer(headerBlock);
        ...
        public synchronized void synReply(boolean outFinished, int streamId,
                                          List<com.android.slyce.async.http.spdy.Header> headerBlock) throws IOException {
            if (closed) throw new IOException("closed");
            com.android.slyce.async.ByteBufferList headerBlockBuffer = writeNameValueBlockToBuffer(headerBlock);
        ...
        @Override
        public synchronized void rstStream(int streamId, com.android.slyce.async.http.spdy.ErrorCode errorCode)
        throws IOException {
            if (closed) throw new IOException("closed");
        ...
        @Override
        public synchronized void data(boolean outFinished, int streamId, com.android.slyce.async.ByteBufferList source) throws IOException {
            int flags = (outFinished ? FLAG_FIN : 0);
            sendDataFrame(streamId, flags, source);
        }

        com.android.slyce.async.ByteBufferList dataList = new com.android.slyce.async.ByteBufferList();
        void sendDataFrame(int streamId, int flags, com.android.slyce.async.ByteBufferList buffer)
        throws IOException {
            if (closed) throw new IOException("closed");
        ...
        com.android.slyce.async.ByteBufferList headerBlockList = new com.android.slyce.async.ByteBufferList();
        private com.android.slyce.async.ByteBufferList writeNameValueBlockToBuffer(List<com.android.slyce.async.http.spdy.Header> headerBlock) throws IOException {
            if (headerBlockList.hasRemaining()) throw new IllegalStateException();
            ByteBuffer headerBlockOut = com.android.slyce.async.ByteBufferList.obtain(8192).order(ByteOrder.BIG_ENDIAN);
            ...
            for (int i = 0, size = headerBlock.size(); i < size; i++) {
                ...
                if (headerBlockOut.remaining() < headerBlockOut.capacity() / 2) {
                    ByteBuffer newOut = com.android.slyce.async.ByteBufferList.obtain(headerBlockOut.capacity() * 2).order(ByteOrder.BIG_ENDIAN);
                    headerBlockOut.flip();
                    newOut.put(headerBlockOut);
                    com.android.slyce.async.ByteBufferList.reclaim(headerBlockOut);
            ...
            while (!deflater.needsInput()) {
                ByteBuffer deflated = com.android.slyce.async.ByteBufferList.obtain(headerBlockOut.capacity()).order(ByteOrder.BIG_ENDIAN);
        ...
        @Override
        public synchronized void goAway(int lastGoodStreamId, com.android.slyce.async.http.spdy.ErrorCode errorCode,
