package com.android.slyce.async.util;
...
public class FileCache {
    ...
    public static class Snapshot {
        ...
        public void close() {
            com.android.slyce.async.util.StreamUtility.closeQuietly(fins);
        }
    }
    ...
    public FileInputStream[] get(String key, int count) throws IOException {
        ...
        try {
            ...
            for (FileInputStream fin: ret) {
                com.android.slyce.async.util.StreamUtility.closeQuietly(fin);
            }
            remove(key);
            throw e;
        }
    ...
    class InternalCache extends com.android.slyce.async.util.LruCache<String, CacheEntry> {
