...
public interface OnSlyceRequestListener {
     ...
     *  */
    void onResultsReceived(JSONObject products);

    /** Called when barcode is found
     * @param barcode a barcode object.
     * */
    void onBarcodeDetected(SlyceBarcode barcode);
     ...
     *  */
    void onImageDetected(String irId, String productInfo);
     ...
     *  */
    void onImageInfoReceived(JSONArray products);
