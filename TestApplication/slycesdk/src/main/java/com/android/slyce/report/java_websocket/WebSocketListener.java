...
public interface WebSocketListener {
	 ...
	 * @throws com.android.slyce.report.java_websocket.exceptions.InvalidDataException
	 ...
	 * security policy.
	 * @throws com.android.slyce.report.java_websocket.exceptions.InvalidDataException thrown when some data that is required to generate the flash-policy like the websocket local port could not be obtained.
	 */
