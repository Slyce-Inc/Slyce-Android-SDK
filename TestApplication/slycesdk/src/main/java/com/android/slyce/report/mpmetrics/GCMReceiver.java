...
import com.android.slyce.report.mpmetrics.MixpanelAPI.InstanceProcessor;
...
* the device status bar. Together with {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#initPushHandling(String) }
...
* get set up Mixpanel messages is call {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String) }
* with a distinct id for your user, and call {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#initPushHandling(String) }
...
* {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#setPushRegistrationId(String)}
* in your own REGISTRATION handler.
*
* @see com.android.slyce.report.mpmetrics.MixpanelAPI#getPeople()
* @see com.android.slyce.report.mpmetrics.MixpanelAPI.People#initPushHandling(String)
