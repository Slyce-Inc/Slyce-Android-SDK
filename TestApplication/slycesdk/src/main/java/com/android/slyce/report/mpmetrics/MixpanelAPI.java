 ...
 *
 * <p>Call {@link #getInstance(android.content.Context, String)} with
 ...
 * using {@link #track(String, org.json.JSONObject)}, and update People Analytics
 ...
 * when you call <tt>track</tt> or {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#set(String, Object)}.
 ...
 * updating People Analytics records with {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People} and registering for
 * and receiving push notifications with {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#initPushHandling(String)}.
 *
...
public class MixpanelAPI {
     ...
     * {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String)} if you wish the new alias to be used for Events and People.
     *
    ...
    /**
     * Associate all future calls to {@link #track(String, org.json.JSONObject)} with the user identified by
     * the given distinct id.
     *
     * <p>This call does not identify the user for People Analytics;
     * to do that, see {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String)}. Mixpanel recommends using
     ...
     *
     * <p>Calls to {@link #track(String, org.json.JSONObject)} made before corresponding calls to
     ...
     *
     * @see com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String)
     */
     ...
     * with events sent using {@link #track(String, org.json.JSONObject)}. Before any calls to
     ...
     * use {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String)} and {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#getDistinctId()}.
     *
     * @return The distinct id associated with event tracking
     *
     * @see #identify(String)
     * @see com.android.slyce.report.mpmetrics.MixpanelAPI.People#getDistinctId()
     */
    ...
    /**
     * Register properties that will be sent with every subsequent call to {@link #track(String, org.json.JSONObject)}.
     *
     * <p>SuperProperties are a collection of properties that will be sent with every event to Mixpanel,
     * and persist beyond the lifetime of your application.
     *
     ...
     * superProperty only if it is currently unset, use {@link #registerSuperPropertiesOnce(org.json.JSONObject)})
     *
     ...
     * @see #registerSuperPropertiesOnce(org.json.JSONObject)
    ...
    /**
     * Remove a single superProperty, so that it will not be sent with future calls to {@link #track(String, org.json.JSONObject)}.
     *
     ...
     * @see #registerSuperProperties(org.json.JSONObject)
     */
     ...
     *
     * @return an instance of {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People} that you can use to update
     ...
     * You can get an instance by calling {@link com.android.slyce.report.mpmetrics.MixpanelAPI#getPeople()}
     *
     ...
     * </pre>
     *
     * @see com.android.slyce.report.mpmetrics.MixpanelAPI
     */
    public interface People {
        /**
         * Associate future calls to {@link #set(org.json.JSONObject)}, {@link #increment(java.util.Map)},
         ...
         *     and {@link com.android.slyce.report.mpmetrics.MixpanelAPI#identify(String)}
         *
         * @see com.android.slyce.report.mpmetrics.MixpanelAPI#identify(String)
         */
        public void identify(String distinctId);
        ...
        /**
         * Works just like {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#set(String, Object)}, except it will not overwrite existing property values. This is useful for properties like "First login date".
         *
         * @param propertyName The name of the Mixpanel property. This must be a String, for example "Zip Code"
         * @param value The value of the Mixpanel property. For "Zip Code", this value might be the String "90210"
         */
        ...
        /**
         * Like {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#set(String, Object)}, but will not set properties that already exist on a record.
         *
         * @param properties a JSONObject containing the collection of properties you wish to apply
         *      to the identified user. Each key in the JSONObject will be associated with
         *      a property name, and the value of that key will be assigned to the property.
         ...
         *
         * <p>To use {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#initPushHandling}, you will need to add the following to your application manifest:
         *
         * <pre>
         * {@code
         ...
         * more information and a list of necessary permissions, see {@link com.android.slyce.report.mpmetrics.GCMReceiver}.
         *
         * <p>If you're planning to use end-to-end support for Messaging, we recommend you
         * call this method immediately after calling {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String)}, likely
         * early in your application's life cycle. (for example, in the onCreate method of your
         * main application activity.)
         *
         * <p>Calls to {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#initPushHandling} should not be mixed with calls to
         ...
         *
         * <p>Calls to {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#setPushRegistrationId} should not be mixed with calls to {@link #initPushHandling(String)}
         ...
         *
         * <p>{@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#clearPushRegistrationId} should only be called after {@link #identify(String)} has been called.
         *
        ...
        /**
         * Returns the string id currently being used to uniquely identify the user associated
         * with events sent using {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#set(String, Object)} and {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#increment(String, double)}.
         * If no calls to {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String)} have been made, this method will return null.
         *
         * <p>The id returned by getDistinctId is independent of the distinct id used to identify
         * any events sent with {@link com.android.slyce.report.mpmetrics.MixpanelAPI#track(String, org.json.JSONObject)}. To read and write that identifier,
         * use {@link com.android.slyce.report.mpmetrics.MixpanelAPI#identify(String)} and {@link com.android.slyce.report.mpmetrics.MixpanelAPI#getDistinctId()}.
         *
         * @return The distinct id associated with updates to People Analytics
         *
         * @see com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String)
         * @see com.android.slyce.report.mpmetrics.MixpanelAPI#getDistinctId()
         */
        public String getDistinctId();
         ...
         * both this and {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#showNotificationIfAvailable(android.app.Activity)} right after each other, and
         ...
         * This method will be a no-op if there is already a survey or in app notification being displayed.
         * Thus, if you have both surveys and in app notification campaigns built in Mixpanel, you may call
         * both this and {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#showSurveyIfAvailable(android.app.Activity)} right after each other, and
         * only one of them will be displayed.
         *
         * <p>This method is a no-op in environments with
         * Android API before JellyBean/API level 16.
         ...
         *
         * @param notif the {@link InAppNotification} to show
         *
         * @param parent the Activity that the mini notification will be displayed in, or the Activity
         * that will be used to launch SurveyActivity for the takeover notification.
         */
         ...
         *
         * @param notif the {@link InAppNotification} associated with the event you'd like to track.
         */
         ...
         * Mixpanel's servers, so it is safe to call this from the UI thread.
         *
         * Note: you must call call {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#trackNotificationSeen(com.android.slyce.report.mpmetrics.InAppNotification)} or you will
         * receive the same {@link InAppNotification} again the
        ...
        /**
         * Tells MixPanel that you have handled an {@link InAppNotification}
         * in the case where you are manually dealing with your notifications ({@link com.android.slyce.report.mpmetrics.MixpanelAPI.People:getNotificationIfAvailable()}).
         *
         * Note: if you do not acknowledge the notification you will receive it again each time
         * you call {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#identify(String)} and then call {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People:getNotificationIfAvailable()}
         *
         ...
         * {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#showSurveyIfAvailable(android.app.Activity)}.
         *
         ...
         * {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#showNotificationIfAvailable(android.app.Activity)}.
         *
         ...
         *
         * <p>Once this listener is called, you may call {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#getSurveyIfAvailable()}
         * or {@link com.android.slyce.report.mpmetrics.MixpanelAPI.People#getNotificationIfAvailable()}
    ...
    private class PeopleImpl implements People {
        ...
        public void trackNotificationSeen(InAppNotification notif) {
            ...
            final People people = getPeople().withIdentity(getDistinctId());
