 ...
 * can replace all of the edits in an app with {@link com.android.slyce.report.viewcrawler.EditState#setEdits(java.util.Map)}.
 *
 * Some client is responsible for informing the EditState about the presence or absence
 * of Activities, by calling {@link com.android.slyce.report.viewcrawler.EditState#add(android.app.Activity)} and {@link com.android.slyce.report.viewcrawler.EditState#remove(android.app.Activity)}
 */
