...
public class AsyncHttpRequest {
    ...
    public static void setDefaultHeaders(com.android.slyce.async.http.Headers ret, Uri uri) {
        if (uri != null) {
    ...
    public AsyncHttpRequest(Uri uri, String method, com.android.slyce.async.http.Headers headers) {
        assert uri != null;
        mMethod = method;
        this.uri = uri;
        if (headers == null)
            mRawHeaders = new com.android.slyce.async.http.Headers();
        else
            mRawHeaders = headers;
        if (headers == null)
    ...
    private com.android.slyce.async.http.body.AsyncHttpRequestBody mBody;
    public void setBody(com.android.slyce.async.http.body.AsyncHttpRequestBody body) {
        mBody = body;
    }
    ...
    public void onHandshakeException(com.android.slyce.async.AsyncSSLException e) {
    }
